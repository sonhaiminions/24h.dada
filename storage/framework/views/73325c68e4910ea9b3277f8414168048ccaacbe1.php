    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <?php endif; ?>
                <form action="admin/user/postedit/<?php echo e($user->id); ?>" method="POST">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <div class="form-group">
                        <label>name </label>
                        <input class="form-control" name="txtName" placeholder="Please Enter  Name" value="<?php echo e($user->name); ?>" />
                    </div>
                    <div class="form-group">
                        <label>username</label>
                        <input class="form-control" name="txtUser" placeholder="Please Enter username" value="<?php echo e($user->user); ?>" />
                    </div>
                    <div class="form-group">
                        <label>Email</label>
